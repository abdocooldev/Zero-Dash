      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) shadow-xl",
          className,
        )}
        {...props}>
        <div
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}>
      {isMobile ? <Menu className="size-6" /> : <PanelLeftIcon />}
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden p-4 group-data-[state=collapsed]:p-2",
        className,
      )}
      {...props}
    />
